...
//---------------------------------------------------------------------
//__Introduction to Angular Modules | Understanding Angular Modules__//

//Модули - это способ группировки строительных блоков Angular (компоненты, директивы, каналы и т. д.).
//Angular не сканирует автоматически весь код и не определяет автоматически компоненты и сервисы.

// Модуль Angular имеет следующую структуру:
// declarations: Массив, содержащий компоненты, директивы и каналы, определенные в модуле.
// imports: Массив, содержащий другие модули, которые импортируются в текущий модуль.
// providers: Массив, содержащий сервисы, которые предоставляются модулем.
// bootstrap: Массив, содержащий корневой компонент приложения.
...
// Использование модулей в Angular имеет ряд преимуществ:
// Организация: Модули помогают организовать и управлять различными частями приложения.
// Изоляция: Модули обеспечивают способ изоляции различных частей приложения друг от друга.
// Повторное использование: Модули можно повторно использовать в нескольких приложениях.
// Тестируемость: Модули облегчают тестирование различных частей приложения.

//---------------------------------------------------------------
//__Creating a Feature Module | Understanding Angular Modules__//

// Функциональный модуль в Angular - это модуль, который содержит компоненты, директивы, каналы и сервисы, связанные с определенной функциональностью приложения.Создание функционального модуля позволяет организовать и управлять различными частями приложения, а также повторно использовать код в нескольких приложениях.

import { NgModule } from '@angular/core';

@NgModule({
  declarations: [
    // Компоненты, директивы и каналы, определенные в модуле
  ],
  imports: [
    // Другие модули, импортированные в текущий модуль
  ],
  providers: [
    // Сервисы, предоставляемые модулем
  ],
  exports: [
    // Компоненты, директивы и каналы, которые должны быть доступны для импорта из других модулей
  ]
})
